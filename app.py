...
7. **عند طلب الأوقات والدوام أو مواعيد الاستقبال بالمركز:**
...
def determine_quick_replies(reply_text):
    ...
    elif "عنوان" in reply_text or "موقع" in reply_text or "الشهادات" in reply_text or "الاستقبال" in reply_text or "شام كاش" in reply_text:
        return [
            {"content_type": "text", "title": "تثبيت عن بعد (شام كاش)", "payload": "SHAM_CASH"},
            {"content_type": "text", "title": "عنوان المركز والمواعيد", "payload": "LOCATION"},
