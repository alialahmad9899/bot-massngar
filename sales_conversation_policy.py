...
HANDOVER_PATTERNS = (
    ...
    r"\bبدي\s+(?:شخص|حدا|انسان)\s+(?:يحكي|يتواصل|يتابع)\s+معي\b",
    r"\bبدي\s+اتواصل\s+مع\s+(?:الادارة|الإدارة)\b",
    r"\bبدي\s+تواصل\s+(?:مباشر|بشري)\b",
    r"\bتواصل\s+مع\s+(?:الادارة|الإدارة)\b",
    r"\bاحكي\s+مع\s+(?:الادارة|الإدارة|موظف|موظفة|حدا)\b",
    r"\bخلي\s+(?:الادارة|الإدارة|موظف|موظفة|حدا)\s+(?:يتواصل|يحكي)\s+معي\b",
    r"\bتحدث\s+مع\s+(?:موظف|موظفة|الادارة|الإدارة)\b",
    r"\bاتواصل\s+مع\s+(?:الادارة|الإدارة|موظف|موظفة)\b",
    r"\bبدي\s+موظف\b",
    r"\bبدي\s+موظفة\b",
    r"\bتواصل\s+مباشر\b",
    r"\bتحدث\s+مع\s+انسان\b",
)
